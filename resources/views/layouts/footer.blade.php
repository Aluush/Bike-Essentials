    ...
    <!-- Footer container -->
    <footer class="text-center  bg-neutral-700 text-white/75 lg:text-left">
        <div
            class="flex items-center justify-center border-b-2  p-6 border-white/10 lg:justify-between">
